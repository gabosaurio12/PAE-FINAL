...
public class FXMLEditarAsistenteVueloController {
    ...
    public void init(String aerolineaSeleccionada, AsistenteVuelo asistente) {
        this.aerolineaSeleccionada = aerolineaSeleccionada;
        inicializarChoiceBox();
        inicializarTextField(asistente);
    }
    
    public void inicializarTextField(AsistenteVuelo asistente) {
        idTF.setText(asistente.getIdentificador());
        nombreTF.setText(asistente.getNombre());
        direccionTF.setText(asistente.getDireccion());
        telefonoTF.setText(asistente.getTelefono());
        correoTF.setText(asistente.getCorreo());
        fechaNacimientoTF.setText(asistente.getFechaNacimiento());
        salarioTF.setText(String.valueOf(asistente.getSalario()));
        idiomasTF.setText(String.valueOf(asistente.getNumIdiomas()));
        horasVueloAsistidasTF.setText(String.valueOf(asistente.getNumHorasAsistidas()));
        generoCB.setValue(asistente.getGenero());
    }
